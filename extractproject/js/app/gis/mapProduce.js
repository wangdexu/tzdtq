...
define(['jquery','dhtmlx','ol'],function($,dhl,ol){
    ...
    var _pointHeight = function(argList){
        ...
        datalist.forEach(function(item){
            ...
            dataheight.push([item,parseFloat(argList.arg[0].cells(item, 2).getValue()),parseFloat(argList.arg[0].cells(item, 3).getValue())])
        });
        ...
        $.ajax({
            url:"http://192.168.31.230:5000/GetPtAlt",
            type:"post",
