$(function() {
	...
	$(".dl_list").delegate(".dl_list_common", "click", function() {
		...
		//	fileName = res.item.items[0].name;
		//	userName = res.item.items[0].userName;
		//	createTime = res.item.items[0].createTime;
		//	editTime = res.item.items[0].editTime;
		//
		//GV.Center.Data.getMetaData({"id":dataId}).then(res=>{
		//	switch(types){
		//		case "0" :
		//			$(".wenjianjiaDetail").show();
		//			$(".wenjianjiaDetail").find("#wenjianjiaDetailTitle").attr("value",fileName);
		//			$(".wenjianjiaDetail").find(".wenjianjia_cjr i").html(userName);
		//			$(".wenjianjiaDetail").find(".wenjianjia_cjsj i").html(createTime);
		//			$(".wenjianjiaDetail").find(".wenjianjia_xgsj i").html(editTime);
		//			break;
		//		case "局部影像" :
		...
		//					$(".wenjianjubu_yx").show();
		//					$(".wenjianjubu_yx").find("#wj_yx_Title").attr("value",data.imageName);
		//					$(".wenjianjubu_yx").find(".wj_yx_gs i").html(data.formate);
		//					$(".wenjianjubu_yx").find(".wj_yx_size i").html(data.fileInfos[0].fileSize);
		//					$(".wenjianjubu_yx").find(".wj_yx_cc i").html(data.rasterXSize + "*" + data.rasterYSize);
		//					$(".wenjianjubu_yx").find(".wj_yx_user i").html(userName);
		//					$(".wenjianjubu_yx").find(".wj_yx_rk i").html(createTime);
		//					$(".wenjianjubu_yx").find(".wj_yx_cj i").html(editTime);
		//					// $(".wenjianjubu_yx").find("#wj_yx_wxlx option[text='"+ datas.SatelliteType +"']").attr("selected",true);
		//					$(".wenjianjubu_yx").find("#wj_yx_wxlx").attr("value",data.satelliteId);
		//					// $(".wenjianjubu_yx").find("#wj_yx_yxlx option[text='"+ datas.ImageType +"']").attr("selected",true);
		//					$(".wenjianjubu_yx").find("#wj_yx_yxlx").val();
		//					// $(".wenjianjubu_yx").find("#wj_yx_yxjb option[text='"+ datas.ImageRecognition +"']").attr("selected",true);
		//					$(".wenjianjubu_yx").find("#wj_yx_yxjb").val();
		//					// $(".wenjianjubu_yx").find("#wj_yx_tyxx option[text='"+ datas.tyxx +"']").attr("selected",true);
		//					$(".wenjianjubu_yx").find("#wj_yx_tyxx").attr("value",data.mapProjection);
		//					$(".wenjianjubu_yx").find("#wj_yx_key").val();
		//					// $(".wenjianjubu_yx").find("#wj_yx_fbl option[text='"+ datas.resolution+"']").attr("selected",true);
		//					$(".wenjianjubu_yx").find("#wj_yx_fbl").attr("value",data.resolution);
		//					// $(".wenjianjubu_yx").find("#wj_yx_rpc option[text='"+ datas.rpc+"']").attr("selected",true);
		//					$(".wenjianjubu_yx").find("#wj_yx_rpc").val();
		//					$(".wenjianjubu_yx").find(".wenjiangc_qx i").html();
		//				},
		//				error: function(data){
		//					openWindow("获取影像数据详细信息失败",false);
		//				}
		//			});
		//			break;
		//		case "局部矢量" :
		//			$(".wenjian_sl").show();
		//			$(".wenjian_sl").find("#wenjian_sl_Title").val(datas.name);
		//			$(".wenjian_sl").find(".wj_sl_wjgs i").html(datas.dataType);
		//			$(".wenjian_sl").find(".wj_sl_size i").html();
		//			$(".wenjian_sl").find(".wj_sl_cc i").html();
		//			$(".wenjian_sl").find(".wj_sl_user i").html(datas.userName);
		//			$(".wenjian_sl").find(".wj_sl_rk i").html(datas.createTime);
		//			$(".wenjian_sl").find(".wj_sl_cj i").html(datas.editTime);
		//			// $(".wenjian_sl").find("#wj_sl_blc option[text='"+ datas.blc +"']").attr("selected",true);
		//			$(".wenjian_sl").find("#wj_sl_blc").val();
		//			// $(".wenjian_sl").find("#wj_sl_ty option[text='"+ datas.tyxx +"']").attr("selected",true);
		//			$(".wenjian_sl").find("#wj_sl_ty").val();
		//			$(".wenjian_sl").find("#wj_sl_gjz").val();
		//			// $(".wenjian_sl").find("#wj_sl_sszt option[text='"+ datas.sszt +"']").attr("selected",true);
		//			$(".wenjian_sl").find("#wj_sl_sszt").val();
		//			$(".wenjian_sl").find(".wj_sl_qx i").html();
		//			break;
		//		case "局部高程":
		//			$(".wenjianjubu_gc").show();
		//			$(".wenjianjubu_gc").find("#wj_gc_title").val(datas.name);
		//			$(".wenjianjubu_gc").find(".wenjiangc_wjgs i").html(datas.dataType);
		//			$(".wenjianjubu_gc").find(".wenjiangc_size i").html();
		//			$(".wenjianjubu_gc").find(".wenjiangc_cc i").html();
		//			$(".wenjianjubu_gc").find(".wenjiangc_cjr i").html(datas.userName);
		//			$(".wenjianjubu_gc").find(".wenjiangc_cjtime i").html(datas.createTime);
		//			$(".wenjianjubu_gc").find(".wenjiangc_rktime i").html(datas.editTime);
		//			// $(".wenjianjubu_gc").find("#wj_gc_gw option[text='"+datas.wgdx+"']").attr("selected",true);
		//			$(".wenjianjubu_gc").find("#wj_gc_gw").val();
		//			// $(".wenjianjubu_gc").find("#wj_gc_ty option[text='"+datas.tyxx+"']").attr("selected",true);
		//			$(".wenjianjubu_gc").find("#wj_gc_ty").val();
		//			$(".wenjianjubu_gc").find("#wj_gc_gjz").val();
		//			// $(".wenjianjubu_gc").find("#wj_gc_fbl option[text= '"+ datas.resolution+"']").attr("selected",true);
		//			$(".wenjianjubu_gc").find("#wj_gc_fbl").val();
		//			$(".wenjianjubu_gc").find(".wenjiangc_qx i").html();
		//			break;
		//		default :
		//			// 其他公共类别
		//			$(".wenjian_other").show();
	...
	$(".wenjianContCont").delegate(".wenjian_common", "click", function() {
		...
		console.log(ids);
		//GV.Center.Data.getFavoritesinfoByID(ids).then(res=>{
		//// GV.Center.Data.getFavoritesinfoByID({"id":ids}).then(res=>{
		//	fileName = res.item.items[0].name;
		//	userName = res.item.items[0].userName;
		//	createTime = res.item.items[0].createTime;
		//	editTime = res.item.items[0].editTime;
	...
	$(".wjjCreat").click(function() {
		...
		//	// 文件夹缩略模式
		//	$(`
		//			<div class="wenjianjia wenjian_common wjj_bs" id="${data.id}" data-type="0" title="${data.name}" data-pid="${data.pids}">
		...
		//	// 文件夹列表模式
		//	$(`
		//			<ul class="dl_list_common clearfix wjj_bs" id="${data.id}"data-type="0" title="${data.name}" data-pid="${data.pids}">
		//				<li class="dl_check"></li>
		//				<li><img src="./img/wenjianjia.png" alt=""><p>${data.name}</p></li>
		//				<li>------</li>
		//				<li>timeWaiting</li>
		//				<li>-------</li>
		//			</ul>
		...
		//	if (pids == -2) {
		//		$(`
		//				 <li class="nav_item clearfix wjj_leftbs" id="${data.id}"data-type="0" title="${data.name}" data-pid="${data.pids}">
		//					<i></i>
		//					<u></u>
		//					<p>${data.name}</p>
		...
		//			`).appendTo($(".left_nav"));
		//	} else {
		//		var $that = $(".left_nav").find("#" + pids + " .nav_item_sWrap");
		//		$(`
		//				 <li class="nav_item clearfix wjj_leftbs" id="${data.id}"data-type="0" title="${data.name}" data-pid="${data.pids}">
		//					<i></i>
		//					<u></u>
	...
	$(".left_nav").delegate(".wjj_leftbs", "click", function(event) {
		...
		$(".left_nav .wjj_leftbs").children("p").css("color", "white").removeClass("activeFlag1");
		$(this).children("p").css("color", "#009999").addClass("activeFlag1");
		var token = "";
		$.ajax({
		...
		$.ajax({
			...
			success: function (res) {
				...
				for (var i in datas) {
					...
					if (datas[i].type=="1") {
						// 文件夹缩略模式
						$('<div class="wenjianjia wenjian_common wjj_bs" id="' + datas[i].id + '" title="' + datas[i].name + '" data-pid="' + datas[i].parentID + '" data-id="' + datas[i].Metadata + '" data-descirbe="' + datas[i].descirbe + '" data-createTime="' + datas[i].createTime + '" data-editTime="' + datas[i].editTime + '" data-userName="' + datas[i].userName + '" data-type="0">' +
							'							<img src="./img/wenjianjia.png" alt="">' +
							'							<p>' + datas[i].name + '</p>' +
							'							<u></u>' +
							'							</div>'
						...
						// 文件夹列表模式
						$('<ul class="dl_list_common clearfix wjj_bs" id="' + datas[i].id + '" title="' + datas[i].name + '" data-pid="' + datas[i].parentID + '"  data-id="' + datas[i].Metadata + '" data-descirbe="' + datas[i].descirbe + '" data-createTime="' + datas[i].createTime + '" data-editTime="' + datas[i].editTime + '" data-userName="' + datas[i].userName + '" data-type="0">' +
							'							<li class="dl_check"></li>' +
